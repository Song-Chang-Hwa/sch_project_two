...
@Component({
    selector: 'app-modalcontent-pref-sql',
    template: `
...
export class ModalContentPrefSqlComponent implements OnInit, OnDestroy {
    params: HttpParams;
...
@Component({
    selector: 'app-modal-pref-sql',
    template: '',
})
export class ModalPrefSqlComponent {
    constructor(private modalService: NgbModal) {}

    open(
        DESIGN_KEY_VALUE: string,
        XML: string,
        SQL: string,
        FULL_XML: string,
        FULL_SQL: string
    ): NgbModalRef {
        const modalRef = this.modalService.open(ModalContentPrefSqlComponent, {
        ...
        modalRef.componentInstance.FULL_XML = FULL_XML;
        modalRef.componentInstance.FULL_SQL = FULL_SQL;
