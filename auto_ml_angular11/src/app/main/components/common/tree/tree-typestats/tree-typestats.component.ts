...
@Component({
    selector: 'app-tree-typestats',
    templateUrl: './tree-typestats.component.html',
})
export class TreeTypeStatsComponent implements OnInit, OnDestroy, AfterViewInit {
    apiUrl = '0';
            ...
            core: {
                ...
                data: {
                    url(node) {
                        ...
                        return self.apiUrl + '/entity/typestatsmstr/selectListForTypeStatsTree';
                    },
                    data(node) {
