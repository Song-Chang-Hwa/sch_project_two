...
@Component({
    selector: 'app-tree-ai-checkable',
    templateUrl: './tree-ai-checkable.component.html',
    styleUrls: ['./tree-ai-checkable.component.scss'],
})
export class TreeAiCheckableComponent implements OnInit, OnDestroy, AfterViewInit {
    apiUrl = '0';
    ...
    ngOnInit() {
        // console.log('TreeAiCheckableComponent', this.exceptItemList);
    }
                ...
                core: {
                    ...
                    data: {
                        url(node) {
                            ...
                            return (
                                self.apiUrl +
                                '/entity/aimstr/selectListForAiCheckableTree?' +
                                exceptItemId
                            );
                        },
                        data(node) {
