...
@Component({
    selector: 'app-tree-typelayout',
    templateUrl: './tree-typelayout.component.html',
})
export class TreeTypeLayoutComponent implements OnInit, OnDestroy, AfterViewInit {
    apiUrl = '0';
                ...
                core: {
                    ...
                    data: {
                        url(node) {
                            ...
                            return (
                                self.apiUrl + '/entity/typelayoutmstr/selectListForTypeLayoutTree'
                            );
                        },
                        data(node) {
