...
@Component({
    selector: 'app-tree-typemanual',
    templateUrl: './tree-typemanual.component.html',
})
export class TreeTypeManualComponent implements OnInit, OnDestroy, AfterViewInit {
    apiUrl = '0';
            ...
            core: {
                ...
                data: {
                    url(node) {
                        ...
                        return self.apiUrl + '/entity/typemanualmstr/selectListForTypeManualTree';
                    },
                    data(node) {
