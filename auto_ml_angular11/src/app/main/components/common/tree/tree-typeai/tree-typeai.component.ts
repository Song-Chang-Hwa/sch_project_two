...
@Component({
    selector: 'app-tree-typeai',
    templateUrl: './tree-typeai.component.html',
})
export class TreeTypeAiComponent implements OnInit, OnDestroy, AfterViewInit {
    apiUrl = '0';
            ...
            core: {
                ...
                data: {
                    url(node) {
                        ...
                        return self.apiUrl + '/entity/typeaimstr/selectListForTypeAiTree';
                    },
                    data(node) {
