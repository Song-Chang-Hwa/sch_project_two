...
@Component({
    selector: 'app-tree-typeabtest',
    templateUrl: './tree-typeabtest.component.html',
})
export class TreeTypeAbTestComponent implements OnInit, OnDestroy, AfterViewInit {
    apiUrl = '0';
            ...
            core: {
                ...
                data: {
                    url(node) {
                        ...
                        return self.apiUrl + '/entity/typeabtestmstr/selectListForTypeAbtestTree';
                    },
                    data(node) {
