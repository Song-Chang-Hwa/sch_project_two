...
export class TreeItemComponent implements OnInit, OnDestroy, AfterViewInit {
    apiUrl = '0';
                ...
                core: {
                    ...
                    data: {
                        url(node) {
                            ...
                            if (self.exceptItemIdList) {
                                for (let i = 0; i < self.exceptItemIdList.length; i++) {
                                    const itemId = self.exceptItemIdList[i];
                                    if (0 === i) {
                                        exceptItemId += itemId;
                                    } else {
                                        exceptItemId += ',' + itemId;
                            ...
                            return (
                                self.apiUrl +
                                '/entity/itemmstr/selectListForItemTree?' +
                                exceptItemId
                            );
                        },
                        data(node) {
