...
@Component({
    selector: 'app-tree-stats-checkable',
    templateUrl: './tree-stats-checkable.component.html',
    styleUrls: ['./tree-stats-checkable.component.scss'],
})
export class TreeStatsCheckableComponent implements OnInit, OnDestroy, AfterViewInit {
    apiUrl = '0';
    ...
    ngOnInit() {
        // console.log('TreeStatsCheckableComponent', this.exceptItemList);
    }
                ...
                core: {
                    ...
                    data: {
                        url(node) {
                            ...
                            return (
                                self.apiUrl +
                                '/model/statsmstr/selectListForStatsCheckableTree?' +
                                exceptItemId
                            );
                        },
                        data(node) {
