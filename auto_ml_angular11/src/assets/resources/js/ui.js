...
$(document).ready(function(){   
	...
	$(function(){
		...
		// 탭 컨텐츠 숨기기
		$('.tabAreaWrap .tab_view').hide();

		// 첫번째 탭콘텐츠 보이기
		$(".tabAreaWrap").each(function () {
		  $(this).children(".tabAreaWrapArea li:first a").addClass("active"); //Activate first tab
		  $(this).children(".tab_view").first().show();
		});
		//탭메뉴 클릭 이벤트
		$(".tabAreaWrapArea li a").click(function () {
		  
		  $(this).parent().siblings("li").removeClass("active");
		  $(this).parent().addClass("active"); $(this).parent().parent().parent().parent().find(".tab_view").hide();
