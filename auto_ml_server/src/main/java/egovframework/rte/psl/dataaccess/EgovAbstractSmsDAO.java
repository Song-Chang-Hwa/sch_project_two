 ...
 * </pre>
 */
public class EgovAbstractSmsDAO extends SqlMapClientDaoSupport {

    /**
     * EgovAbstractSmsDAO 는 base class 로만 사용되며 해당 인스턴스를 직접
     * 생성할 수 없도록 protected constructor 로 선언하였음.
     */
    protected EgovAbstractSmsDAO() {
