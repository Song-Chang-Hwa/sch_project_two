...
public class User implements UserDetails, CredentialsContainer, Serializable {
	...
	public User(String username, String password, String accessToken, Collection<? extends GrantedAuthority> authorities) {
		this(username, password, accessToken, true, true, true, true, authorities);
	}
	public User(String username, String password, String accessToken, boolean enabled,
