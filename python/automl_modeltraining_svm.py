###########################################################
# 4. 모델 학습 - SVM, automl_modeltraining_svm.py
###########################################################
...
class Automl_Modeltraining_SVM:
    isLocal = False
    ...
    def recognition(self, parameterList):
        ...
        #    (6-3) 학습결과 - 테이블(TB_AUTOML_TRAINING_RESULT)에 저장하기 
        ...
        insertDocSn = docSn     
        training_gubun = '13'    # 학습 구분 : 13 - (SVM)
        ...
        # (7-3) SVM > Confusion Matrix - 매트릭스 그리기 
        ...
        #       SVM > Confusion Matrix - 서버에 저장하기   
        image_gubun = 20   # 이미지 구분
             
        dataconfirmFilePath = r"C:/dev_project/aiblue_ocr/textimagefile"
        imageFileNm =  '/SVM20_' + insertDocSn + '.png'
        imageFile   =  'SVM20_' + insertDocSn + '.png'
        plt.savefig(dataconfirmFilePath + imageFileNm)       
        ...
        #      SVM > Confusion Matrix 이미지 - 테이블(TB_AUTOML_TRAINING_IMAGE)에 저장하기 
        file_nm   = imageFile
        file_path = dataconfirmFilePath
        file_full_path = dataconfirmFilePath + '/' + imageFile
...
if __name__ == '__main__':
    Automl_Modeltraining_SVM = Automl_Modeltraining_SVM()
    parameterList = {}
    ...
    Automl_Modeltraining_SVM.recognition(parameterList)